...
class make_ngaldataset():

    def __init__(self, mode, seed, f_prop, f_off, f_prop_norm, f_params, features, num, n, sim):
...
def create_dataset(mode, seed, f_prop, f_off, f_prop_norm, f_params, features,
    ...
    data_set = make_ngaldataset(mode, seed, f_prop, f_off, f_prop_norm, f_params, features, num, n, sim)
